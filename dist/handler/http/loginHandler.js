            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (bcrypt_1["default"].compareSync(pwd, user.pwd)) {
                        ...
                        throw boom_1["default"].unauthorized('email or password not correct');
                    }
                    return [2 /*return*/];
            }
        });
...
function loginPost(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var body, user, expireDays, token, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    body = req.body;
                    return [4 /*yield*/, validate(body.email, body.pwd)];
                case 1:
                    user = _a.sent();
                    expireDays = 7;
                    token = jsonwebtoken_1["default"].sign({ email: user.email }, process.env.JWT_SECRET, { expiresIn: "".concat(expireDays, " days") });
