...
import { myObject } from './utils/windConfig'
...
app.use(cors(corsOptions))
  ...
  .get('/api/msg/privateMsgList', loginValidator, msgHandler.privateMsgInfoListGet)
  .get('/api/msg/privateMsg', loginValidator, msgHandler.privateMsgInfoGet)
  .post('/api/msg/privateMsg', loginValidator, msgHandler.privateMsgInfoPost)
  ...
  .get('/api/privateMsgByOffset', loginValidator, msgHandler.getPrivateMsgByOffset)
  // test only
  .get('/api/ts', loginValidator, async (req, res) => {
    res.json({data: await testPromiseWithTs()})
  })
  .get('/api/module', (req, res) => {
    res.json( { data: myObject})
  })
