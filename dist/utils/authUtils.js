...
exports.getUserFromReq = exports.loginValidator = exports.getUserFromCookieToken = void 0;
var prismaHolder_1 = require("../utils/prismaHolder");
var jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
var Boom = __importStar(require("@hapi/boom"));
function getUserFromCookieToken(token) {
...
exports.getUserFromCookieToken = getUserFromCookieToken;
var loginValidator = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, exports.getUserFromReq)(req)];
            case 1:
                user = _a.sent();
                if (!user) {
...
var getUserFromReq = function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var token;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, getUserFromCookieToken(token)];
